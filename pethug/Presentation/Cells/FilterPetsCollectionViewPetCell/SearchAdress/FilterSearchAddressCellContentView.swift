//
//  FilterSearchAddressCellContentView.swift
//  pethug
//
...
final class FilterSearchAddressCellContentView: UIView, UIContentView {
    ...
    // MARK: - Properties
    private var currentConfiguration: FilterSearchAddressListCellConfiguration!
    var configuration: UIContentConfiguration {
        get {
            currentConfiguration
        } set {
            guard let newConfiguration = newValue as? FilterSearchAddressListCellConfiguration else {
                return
            }
    ...
    // MARK: - LifeCycle
    init(configuration: FilterSearchAddressListCellConfiguration) {
...
//        currentConfiguration.viewModel?.delegate?.textViewdDidChange(text: textField.text ?? "")
    ...
    // MARK: - Functions
    private func apply(configuration: FilterSearchAddressListCellConfiguration) {
