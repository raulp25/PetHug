...
class NewPetViewModelSuccessTests: XCTestCase {
    ...
    */
    ...
    func test_with_successful_create_pet() async throws {
        ...
        defer {
            XCTAssertEqual(stateSpy.values, [.loading, .success], "The published value should be equal to [.loadingm, .success]")
        }
    ...
    func test_with_successful_update_pet() async throws {
        ...
        defer {
            XCTAssertEqual(editStateSpy.values, [.loading, .success], "The published value should be equal to [.loadingm, .success]")
        }
